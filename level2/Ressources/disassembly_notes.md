...
Dump of assembler code for function p:
   ...
   0x080484df <+11>:	mov    %eax,(%esp)            ; load argument 1 -  stdout
   ...
   0x080484ea <+22>:	mov    %eax,(%esp)            ; load argument 1 - buffer
   0x080484ed <+25>:	call   0x80483c0 <gets@plt>   ; gets(buffer); (vulnerable to buffer overflow)
   ...
   0x0804850f <+59>:	mov    %edx,0x4(%esp)         ; load argument 2 - return_address
   0x08048513 <+63>:	mov    %eax,(%esp)            ; load argument 1 - "(%p)\n"
